# 🎫 TICKET DE INTERVENCIÓN — 6341BED4
**Estado:** PENDIENTE DE ASIGNACIÓN
**Prioridad:** ÉLITE ALTO
**Elite Score:** 83.4 / 120
**Generado:** 2026-05-08 11:27:34 UTC
...
| Campo | Valor |
|:------|:------|
| **Activo Afectado** | Barrancabermeja |
| **Operador** | Ecopetrol |
| **Coordenadas** | 7.065000, -73.850000 |
| **CH4 Total** | 2132.7 ppb |
| **Anomalía** | 212.7 ppb sobre el fondo |
| **Certificación Espectral** | CERTIFICADO |
| **Methane Index** | 0.2500 |
| **Probabilidad Gas Real** | 99.0% |
| **Fuente de Datos** | TROPOMI/Sentinel-5P + Open-Meteo |

## 2. Cuantificación de Impacto

| Métrica | Valor |
|:--------|:------|
| **Tasa de Emisión** | 0.0526 kg/h |
| **Pérdida Económica** | $0.25 USD/día |
| **Impacto Ambiental** | 12.90 Ton CO₂e/año |

## 3. Inteligencia de Campo (Proyección de Pluma)

| Campo | Valor |
|:------|:------|
| **Velocidad del Viento** | 2.2 m/s |
| **Dirección del Viento** | 193° |
| **Alcance Proyectado (1h)** | 7.78 km |
| **Punto de Intercepción** | [7.133259, -73.834121] |
| **Persistencia** | 30 día(s) consecutivos |
